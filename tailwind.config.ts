  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        diamante: {
          DEFAULT: "hsl(var(--diamante))",
          foreground: "hsl(var(--diamante-foreground))",
        },
        ouro: {
          DEFAULT: "hsl(var(--ouro))",
          foreground: "hsl(var(--ouro-foreground))",
        },
        prata: {
          DEFAULT: "hsl(var(--prata))",
          foreground: "hsl(var(--prata-foreground))",
        },
        bronze: {
